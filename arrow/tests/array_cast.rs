...
fn get_all_types() -> Vec<DataType> {
    ...
    vec![
        ...
        Dictionary(Box::new(DataType::Int16), Box::new(DataType::LargeUtf8)),
        Dictionary(Box::new(DataType::Int16), Box::new(DataType::Binary)),
        Dictionary(Box::new(DataType::Int16), Box::new(DataType::LargeBinary)),
        Dictionary(Box::new(DataType::UInt32), Box::new(DataType::Utf8)),
        Dictionary(Box::new(DataType::UInt32), Box::new(DataType::LargeUtf8)),
        Dictionary(Box::new(DataType::UInt32), Box::new(DataType::Binary)),
        Dictionary(Box::new(DataType::UInt32), Box::new(DataType::LargeBinary)),
        Decimal128(38, 0),
