...
mod tests {
    ...
    fn test_string_concat() {
        ...
        let output = concat_elements_bytes(&left, &right).unwrap();
    ...
    fn test_string_concat_error() {
        ...
        let output = concat_elements_bytes(&left, &right);
    ...
    fn test_string_concat_slice() {
        ...
        let output = concat_elements_bytes(
            left_slice
                .as_any()
    ...
    fn test_concat_dyn_same_type() {
        ...
        let output: StringArray = concat_elements_bytes(&left, &right)
            .unwrap()
            .into_data()
            .into();
        ...
        let output: LargeStringArray = concat_elements_bytes(&left, &right)
            .unwrap()
            .into_data()
            .into();
        ...
        let output: BinaryArray = concat_elements_bytes(&left, &right)
            .unwrap()
            .into_data()
            .into();
        ...
        let output: LargeBinaryArray = concat_elements_bytes(&left, &right)
            .unwrap()
            .into_data()
            .into();
