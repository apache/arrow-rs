...
///
///   // We can't obtain the ListBuilder<StructBuilder> with the expected generic types, because under the hood the StructBuilder was created as a Box<dyn ArrayBuilder>
///   
