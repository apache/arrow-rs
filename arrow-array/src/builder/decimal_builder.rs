...
use crate::builder::{ArrayBuilder, FixedSizeBinaryBuilder};
use crate::decimal::Decimal256;
use crate::{ArrayRef, Decimal128Array, Decimal256Array};
...
impl Decimal128Builder {
    ...
    #[inline]
    pub fn append_value(&mut self, value: impl Into<i128>) -> Result<(), ArrowError> {
...
impl Decimal256Builder {
    ...
    #[inline]
    pub fn append_value(&mut self, value: &Decimal256) -> Result<(), ArrowError> {
