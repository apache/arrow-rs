...
pub fn create_metadata(json_value: &Value, sort_keys: bool) -> Result<Vec<u8>, ArrowError> {
...
pub fn parse_metadata(metadata: &[u8]) -> Result<HashMap<String, usize>, ArrowError> {
