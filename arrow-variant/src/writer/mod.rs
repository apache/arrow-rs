...
/// ```
pub fn to_json_value(variant: &Variant) -> Result<Value, ArrowError> {
...
/// ]);
/// ```
pub fn to_json_value_array(variant_array: &StructArray) -> Result<Vec<Value>, ArrowError> {
...
/// ```
pub fn to_json(variant: &Variant) -> Result<String, ArrowError> {
...
/// ```
pub fn to_json_array(variant_array: &StructArray) -> Result<Vec<String>, ArrowError> {
