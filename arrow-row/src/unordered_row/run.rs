...
use super::{UnorderedRowConverter, UnorderedRows, variable};
...
pub unsafe fn decode<R: RunEndIndexType>(
    ...
    for (idx, row) in rows.iter_mut().enumerate() {
        ...
        let consumed = variable::decode_blocks(row, |block| {
...
#[cfg(test)]
mod tests {
    use super::{UnorderedRowConverter};
    ...
    fn assert_roundtrip<R: RunEndIndexType>(
        ...
        let sort_field = Field::new("col_1", DataType::RunEndEncoded(
    ...
    fn test_run_end_encoded_supports_datatype() {
        // Test that the UnorderedRowConverter correctly supports run-end encoded arrays
        assert!(UnorderedRowConverter::supports_datatype(&DataType::RunEndEncoded(
    ...
    fn test_run_end_encoded_round_trip_int16_int64s() {
        ...
        assert_roundtrip(&array, DataType::Int16, DataType::Int64);
    }
    ...
    fn test_run_end_encoded_round_trip_int32_int64s() {
        ...
        assert_roundtrip(&array, DataType::Int32, DataType::Int64);
    }
    ...
    fn test_run_end_encoded_round_trip_int64_int64s() {
        ...
        assert_roundtrip(&array, DataType::Int64, DataType::Int64);
    }
    ...
    fn test_run_end_encoded_round_trip_strings() {
        ...
        assert_roundtrip(&array, DataType::Int32, DataType::Utf8);
    }
    ...
    fn test_run_end_encoded_nulls_first_last_configurations() {
        ...
        let converter_nulls_first = UnorderedRowConverter::new(vec![Field::new("col_1",
        ...
        let converter_nulls_last = UnorderedRowConverter::new(vec![Field::new("col_1",
            DataType::RunEndEncoded(
                Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
                Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
            ),
    ...
    fn test_run_end_encoded_row_consumption() {
        ...
        let multi_converter = UnorderedRowConverter::new(vec![
            Field::new("col_1", DataType::RunEndEncoded(
                Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
                Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
            ), true),
    ...
    fn test_run_end_encoded_sorting_behavior() {
        ...
        // Test ascending sort
        let converter_asc = UnorderedRowConverter::new(vec![Field::new("col_1", DataType::RunEndEncoded(
            Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
            Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
        ), true)].into())
        .unwrap();
        ...
        let converter_desc = UnorderedRowConverter::new(vec![Field::new(
            "col_1",
            DataType::RunEndEncoded(
                Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
                Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
        ...
        assert_eq!(rows2_asc.iter().collect::<Vec<_>>(), rows2_desc.iter().collect::<Vec<_>>());
        assert_eq!(rows3_asc.iter().collect::<Vec<_>>(), rows3_desc.iter().collect::<Vec<_>>());
    }
    ...
    fn test_run_end_encoded_mixed_sorting() {
        ...
        let converter = UnorderedRowConverter::new(vec![Field::new("col_1",
                                                                   DataType::RunEndEncoded(
                Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
                Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
            ),
    ...
    fn test_run_end_encoded_empty() {
        ...
        let converter = UnorderedRowConverter::new(vec![Field::new("col_1", DataType::RunEndEncoded(
            Arc::new(arrow_schema::Field::new("run_ends", DataType::Int32, false)),
            Arc::new(arrow_schema::Field::new("values", DataType::Utf8, true)),
        ), true)].into())
        .unwrap();
