...
mod tests {
    ...
    //
    // Note: this is a copy of the helper of the same name in
    // parquet/tests/arrow_writer/roundtrip.rs. It is retained here because the
    // `test_page_stats_*` tests below cannot move to an integration test as
    // they rely on crate-private thrift APIs to decode page headers.
