...
mod snappy_codec {
    ...
    impl Codec for SnappyCodec {
        fn decompress(
            ...
            vec_util::fast_resize(output_buf, offset + len);
        ...
        fn compress(&mut self, input_buf: &[u8], output_buf: &mut Vec<u8>) -> Result<()> {
            ...
            vec_util::fast_resize(output_buf, output_buf_len + required_len);
            let n = self
                .encoder
...
mod lz4_raw_codec {
    ...
    impl Codec for LZ4RawCodec {
        fn decompress(
            ...
            vec_util::fast_resize(output_buf, offset + required_len);
...
mod lz4_hadoop_codec {
    ...
    impl Codec for LZ4HadoopCodec {
        fn decompress(
            ...
            vec_util::fast_resize(output_buf, output_len + required_len);
        ...
        fn compress(&mut self, input_buf: &[u8], output_buf: &mut Vec<u8>) -> Result<()> {
            ...
            let offset = output_buf.len();
            vec_util::fast_resize(output_buf, offset + PREFIX_LEN);
