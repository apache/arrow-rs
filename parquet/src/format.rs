...
impl crate::thrift::TSerializable for TimeUnit {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(TimeUnit::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      TimeUnit::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown TimeUnit field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for LogicalType {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(LogicalType::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      LogicalType::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown LogicalType field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for BloomFilterAlgorithm {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(BloomFilterAlgorithm::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      BloomFilterAlgorithm::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown BloomFilterAlgorithm field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for BloomFilterHash {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(BloomFilterHash::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      BloomFilterHash::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown BloomFilterHash field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for BloomFilterCompression {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(BloomFilterCompression::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      BloomFilterCompression::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown BloomFilterCompression field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for ColumnCryptoMetaData {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(ColumnCryptoMetaData::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      ColumnCryptoMetaData::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown ColumnCryptoMetaData field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for ColumnOrder {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(ColumnOrder::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      ColumnOrder::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown ColumnOrder field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
...
impl crate::thrift::TSerializable for EncryptionAlgorithm {
    ...
    loop {
      ...
      match field_id {
        ...
        _ => {
          i_prot.skip(field_ident.field_type)?;
          if ret.is_none() {
            ret = Some(EncryptionAlgorithm::__UNKNOWN__{ field_id });
          }
          received_field_count += 1;
        },
      };
  ...
  fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
    ...
    match *self {
      ...
      EncryptionAlgorithm::__UNKNOWN__{ field_id: id } => {
        panic!("attempt to write unknown EncryptionAlgorithm field {}", id);
      },
    }
    o_prot.write_field_stop()?;
    o_prot.write_struct_end()
