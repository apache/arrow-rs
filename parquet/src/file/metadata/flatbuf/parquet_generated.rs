...
pub mod parquet {
    ...
    pub mod format {
        ...
        #[allow(non_camel_case_types)]
        pub const ENUM_VALUES_COMPRESSION_CODEC: [CompressionCodec; 8] = [
        ...
        pub const ENUM_VALUES_TIME_UNIT: [TimeUnit; 3] =
            [TimeUnit::MILLIS, TimeUnit::MICROS, TimeUnit::NANOS];
        ...
        #[allow(non_upper_case_globals)]
        impl TimeUnit {
            pub const MILLIS: Self = Self(0);
            pub const MICROS: Self = Self(1);
            pub const NANOS: Self = Self(2);

            pub const ENUM_MIN: i8 = 0;
            pub const ENUM_MAX: i8 = 2;
            pub const ENUM_VALUES: &'static [Self] = &[Self::MILLIS, Self::MICROS, Self::NANOS];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
        ...
        pub const ENUM_MIN_COLUMN_CRYPTO_METADATA: u8 = 0;
        #[deprecated(
            since = "2.0.0",
            note = "Use associated constants instead. This will no longer be generated in 2021."
        )]
        pub const ENUM_MAX_COLUMN_CRYPTO_METADATA: u8 = 2;
        #[deprecated(
            since = "2.0.0",
            note = "Use associated constants instead. This will no longer be generated in 2021."
        )]
        #[allow(non_camel_case_types)]
        pub const ENUM_VALUES_COLUMN_CRYPTO_METADATA: [ColumnCryptoMetadata; 3] = [
        ...
        impl<'a> DecimalOptions<'a> {
            ...
            pub fn precision(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DecimalOptions::VT_PRECISION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn scale(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DecimalOptions::VT_SCALE, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DecimalOptionsBuilder<'a, 'b, A> {
            ...
            pub fn add_precision(&mut self, precision: i32) {
                self.fbb_
                    .push_slot::<i32>(DecimalOptions::VT_PRECISION, precision, 0);
            }
            #[inline]
            pub fn add_scale(&mut self, scale: i32) {
                self.fbb_
                    .push_slot::<i32>(DecimalOptions::VT_SCALE, scale, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> DecimalOptionsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> TimeOptions<'a> {
            ...
            pub fn is_adjusted_to_utc(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(TimeOptions::VT_IS_ADJUSTED_TO_UTC, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unit(&self) -> TimeUnit {
                ...
                unsafe {
                    self._tab
                        .get::<TimeUnit>(TimeOptions::VT_UNIT, Some(TimeUnit::MILLIS))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TimeOptionsBuilder<'a, 'b, A> {
            ...
            pub fn add_is_adjusted_to_utc(&mut self, is_adjusted_to_utc: bool) {
                self.fbb_.push_slot::<bool>(
                    TimeOptions::VT_IS_ADJUSTED_TO_UTC,
                    is_adjusted_to_utc,
                    false,
                );
            }
            ...
            pub fn add_unit(&mut self, unit: TimeUnit) {
                self.fbb_
                    .push_slot::<TimeUnit>(TimeOptions::VT_UNIT, unit, TimeUnit::MILLIS);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> TimeOptionsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                TimeOptionsBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> IntOptions<'a> {
            ...
            pub fn bit_width(&self) -> i8 {
                ...
                unsafe {
                    self._tab
                        .get::<i8>(IntOptions::VT_BIT_WIDTH, Some(8))
                        .unwrap()
                }
            }
            #[inline]
            pub fn is_signed(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(IntOptions::VT_IS_SIGNED, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> IntOptionsBuilder<'a, 'b, A> {
            ...
            pub fn add_bit_width(&mut self, bit_width: i8) {
                self.fbb_
                    .push_slot::<i8>(IntOptions::VT_BIT_WIDTH, bit_width, 8);
            }
            #[inline]
            pub fn add_is_signed(&mut self, is_signed: bool) {
                self.fbb_
                    .push_slot::<bool>(IntOptions::VT_IS_SIGNED, is_signed, false);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> IntOptionsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                IntOptionsBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> ::flatbuffers::Follow<'a> for VariantType<'a> {
            type Inner = VariantType<'a>;
            #[inline]
            unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
                Self {
                    _tab: unsafe { ::flatbuffers::Table::new(buf, loc) },
        ...
        impl<'a> VariantType<'a> {
            pub const VT_SPECIFICATION_VERSION: ::flatbuffers::VOffsetT = 4;

            #[inline]
            pub unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
                VariantType { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<
                'bldr: 'args,
            ...
            >(
                _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
                args: &'args VariantTypeArgs,
            ) -> ::flatbuffers::WIPOffset<VariantType<'bldr>> {
                let mut builder = VariantTypeBuilder::new(_fbb);
                if let Some(x) = args.specification_version {
                    builder.add_specification_version(x);
                }
                builder.finish()
            }

            #[inline]
            pub fn specification_version(&self) -> Option<i8> {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab
                        .get::<i8>(VariantType::VT_SPECIFICATION_VERSION, None)
                }
            }
        }

        impl ::flatbuffers::Verifiable for VariantType<'_> {
            #[inline]
            fn run_verifier(
                v: &mut ::flatbuffers::Verifier,
                pos: usize,
        ...
        pub struct VariantTypeArgs {
            pub specification_version: Option<i8>,
        }
        impl<'a> Default for VariantTypeArgs {
            #[inline]
            fn default() -> Self {
                VariantTypeArgs {
        ...
        pub struct VariantTypeBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
            fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
        }
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> VariantTypeBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_specification_version(&mut self, specification_version: i8) {
                self.fbb_.push_slot_always::<i8>(
                    VariantType::VT_SPECIFICATION_VERSION,
                    specification_version,
                );
            }
            #[inline]
            ...
            #[inline]
            pub fn finish(self) -> ::flatbuffers::WIPOffset<VariantType<'a>> {
                let o = self.fbb_.end_table(self.start_);
                ::flatbuffers::WIPOffset::new(o.value())
            }
        }

        impl ::core::fmt::Debug for VariantType<'_> {
            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                let mut ds = f.debug_struct("VariantType");
                ds.field("specification_version", &self.specification_version());
                ds.finish()
            }
        }
        ...
        impl<'a> BloomFilterInfo<'a> {
            ...
            pub fn offset(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(BloomFilterInfo::VT_OFFSET, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn length(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(BloomFilterInfo::VT_LENGTH, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BloomFilterInfoBuilder<'a, 'b, A> {
            ...
            pub fn add_offset(&mut self, offset: i64) {
                self.fbb_
                    .push_slot::<i64>(BloomFilterInfo::VT_OFFSET, offset, 0);
            }
            #[inline]
            pub fn add_length(&mut self, length: i32) {
                self.fbb_
                    .push_slot::<i32>(BloomFilterInfo::VT_LENGTH, length, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> BloomFilterInfoBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> SchemaElement<'a> {
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn logical_type_as_variant_type(&self) -> Option<VariantType<'a>> {
                if self.logical_type_type() == LogicalType::VariantType {
                    self.logical_type().map(|t| {
                        // Safety:
                        // Created from a valid Table for this object
                        // Which contains a valid union in this slot
                        unsafe { VariantType::init_from_table(t) }
                    })
                } else {
                    None
                }
     ...
     .visit_union::<LogicalType, _>("logical_type_type", Self::VT_LOGICAL_TYPE_TYPE, "logical_type", Self::VT_LOGICAL_TYPE, false, |key, v, pos| {
        match key {
          ...
          LogicalType::VariantType => v.verify_union_variant::<::flatbuffers::ForwardsUOffset<VariantType>>("LogicalType::VariantType", pos),
     ...
     .finish();
        ...
        impl<'a> KeyValue<'a> {
            ...
            pub fn val(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(KeyValue::VT_VAL, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KeyValueBuilder<'a, 'b, A> {
            ...
            pub fn add_val(&mut self, val: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(KeyValue::VT_VAL, val);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> ColumnMetadata<'a> {
            ...
            pub fn bloom_filter(&self) -> Option<BloomFilterInfo<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<BloomFilterInfo>>(
                            ColumnMetadata::VT_BLOOM_FILTER,
                            None,
                        )
                }
            }
        ...
        impl ::flatbuffers::Verifiable for ColumnMetadata<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<BloomFilterInfo>>(
                        "bloom_filter",
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ColumnMetadataBuilder<'a, 'b, A> {
            ...
            pub fn add_bloom_filter(
                &mut self,
                bloom_filter: ::flatbuffers::WIPOffset<BloomFilterInfo<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<BloomFilterInfo>>(
                        ColumnMetadata::VT_BLOOM_FILTER,
                        bloom_filter,
                    );
            }
        ...
        impl<'a> ColumnChunk<'a> {
            pub const VT_META_DATA: ::flatbuffers::VOffsetT = 4;
            pub const VT_CRYPTO_METADATA_TYPE: ::flatbuffers::VOffsetT = 6;
            pub const VT_CRYPTO_METADATA: ::flatbuffers::VOffsetT = 8;
            pub const VT_ENCRYPTED_COLUMN_METADATA: ::flatbuffers::VOffsetT = 10;
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn crypto_metadata_as_encryption_with_footer_key(&self) -> Option<Empty<'a>> {
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn crypto_metadata_as_encryption_with_column_key(&self) -> Option<Empty<'a>> {
        ...
        impl ::flatbuffers::Verifiable for ColumnChunk<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<ColumnMetadata>>(
                        "meta_data",
                        Self::VT_META_DATA,
                        false,
                    )?
                    .visit_union::<ColumnCryptoMetadata, _>(
                        "crypto_metadata_type",
                        Self::VT_CRYPTO_METADATA_TYPE,
                        "crypto_metadata",
                        Self::VT_CRYPTO_METADATA,
                        false,
                        |key, v, pos| match key {
                            ColumnCryptoMetadata::EncryptionWithFooterKey => {
                                v.verify_union_variant::<::flatbuffers::ForwardsUOffset<Empty>>(
                                    "ColumnCryptoMetadata::EncryptionWithFooterKey",
                                    pos,
                                )
                            }
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i8>>>(
                        ...
                        Self::VT_ENCRYPTED_COLUMN_METADATA,
                        false,
                    )?
                    .finish();
                Ok(())
