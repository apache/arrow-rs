...
pub mod parquet {
    ...
    pub mod format_3 {
        ...
        impl FieldRepetitionType {
            ...
            pub const ENUM_VALUES: &'static [Self] =
                &[Self::REQUIRED, Self::OPTIONAL, Self::REPEATED];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
        ...
        #[allow(non_camel_case_types)]
        pub const ENUM_VALUES_TIME_UNIT: [TimeUnit; 3] = [TimeUnit::MS, TimeUnit::US, TimeUnit::NS];
        ...
        impl TimeUnit {
            ...
            pub const ENUM_MIN: i8 = 0;
            pub const ENUM_MAX: i8 = 2;
            pub const ENUM_VALUES: &'static [Self] = &[Self::MS, Self::US, Self::NS];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
                    Self::MS => Some("MS"),
        ...
        pub const ENUM_VALUES_COLUMN_ORDER: [ColumnOrder; 2] =
            [ColumnOrder::NONE, ColumnOrder::TypeDefinedOrder];
        ...
        impl ColumnOrder {
            ...
            pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::TypeDefinedOrder];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
                    Self::NONE => Some("NONE"),
        ...
        impl EncryptionAlgorithm {
            ...
            pub const ENUM_VALUES: &'static [Self] =
                &[Self::NONE, Self::AesGcmV1, Self::AesGcmCtrV1];
            /// Returns the variant's name or "" if unknown.
            pub fn variant_name(self) -> Option<&'static str> {
                match self {
                    Self::NONE => Some("NONE"),
        ...
        impl<'a> DecimalOpts<'a> {
            ...
            pub fn precision(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DecimalOpts::VT_PRECISION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn scale(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(DecimalOpts::VT_SCALE, Some(0))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DecimalOptsBuilder<'a, 'b, A> {
            ...
            pub fn add_precision(&mut self, precision: i32) {
                self.fbb_
                    .push_slot::<i32>(DecimalOpts::VT_PRECISION, precision, 0);
            }
            #[inline]
        ...
        impl<'a> TimeOpts<'a> {
            ...
            pub fn is_adjusted_to_utc(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(TimeOpts::VT_IS_ADJUSTED_TO_UTC, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn unit(&self) -> TimeUnit {
                ...
                unsafe {
                    self._tab
                        .get::<TimeUnit>(TimeOpts::VT_UNIT, Some(TimeUnit::MS))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TimeOptsBuilder<'a, 'b, A> {
            ...
            pub fn add_is_adjusted_to_utc(&mut self, is_adjusted_to_utc: bool) {
                self.fbb_.push_slot::<bool>(
                    TimeOpts::VT_IS_ADJUSTED_TO_UTC,
                    is_adjusted_to_utc,
                    false,
                );
            }
            ...
            pub fn add_unit(&mut self, unit: TimeUnit) {
                self.fbb_
                    .push_slot::<TimeUnit>(TimeOpts::VT_UNIT, unit, TimeUnit::MS);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> TimeOptsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                TimeOptsBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> IntOpts<'a> {
            ...
            pub fn is_signed(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(IntOpts::VT_IS_SIGNED, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> IntOptsBuilder<'a, 'b, A> {
            ...
            pub fn add_bit_width(&mut self, bit_width: i8) {
                self.fbb_
                    .push_slot::<i8>(IntOpts::VT_BIT_WIDTH, bit_width, 8);
            }
            #[inline]
            pub fn add_is_signed(&mut self, is_signed: bool) {
                self.fbb_
                    .push_slot::<bool>(IntOpts::VT_IS_SIGNED, is_signed, false);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> IntOptsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                IntOptsBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> GeometryType<'a> {
            ...
            pub fn crs(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(GeometryType::VT_CRS, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GeometryTypeBuilder<'a, 'b, A> {
            ...
            pub fn add_crs(&mut self, crs: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(GeometryType::VT_CRS, crs);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> GeometryTypeBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                GeometryTypeBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> GeographyType<'a> {
            ...
            pub fn crs(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(GeographyType::VT_CRS, None)
                }
            }
            #[inline]
            pub fn algorithm(&self) -> EdgeInterpolationAlgorithm {
                ...
                unsafe {
                    self._tab
                        .get::<EdgeInterpolationAlgorithm>(
                            GeographyType::VT_ALGORITHM,
        ...
        impl ::flatbuffers::Verifiable for GeographyType<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<EdgeInterpolationAlgorithm>(
                        "algorithm",
                        Self::VT_ALGORITHM,
                        false,
                    )?
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> GeographyTypeBuilder<'a, 'b, A> {
            ...
            pub fn add_crs(&mut self, crs: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(GeographyType::VT_CRS, crs);
            }
            #[inline]
            pub fn add_algorithm(&mut self, algorithm: EdgeInterpolationAlgorithm) {
                self.fbb_.push_slot::<EdgeInterpolationAlgorithm>(
                    GeographyType::VT_ALGORITHM,
                    algorithm,
                    EdgeInterpolationAlgorithm::SPHERICAL,
                );
        ...
        impl<'a> Statistics<'a> {
            ...
            >(
                ...
                if let Some(x) = args.null_count {
                    builder.add_null_count(x);
                }
                if let Some(x) = args.max_len {
                    builder.add_max_len(x);
                }
                if let Some(x) = args.min_len {
                    builder.add_min_len(x);
                }
                builder.finish()
            }
            ...
            pub fn min_lo4(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(Statistics::VT_MIN_LO4, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn min_lo8(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Statistics::VT_MIN_LO8, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn min_hi8(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Statistics::VT_MIN_HI8, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn max_lo4(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(Statistics::VT_MAX_LO4, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn max_lo8(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Statistics::VT_MAX_LO8, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn max_hi8(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(Statistics::VT_MAX_HI8, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn prefix(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(Statistics::VT_PREFIX, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> StatisticsBuilder<'a, 'b, A> {
            ...
            pub fn add_null_count(&mut self, null_count: i32) {
                self.fbb_
                    .push_slot_always::<i32>(Statistics::VT_NULL_COUNT, null_count);
            }
            #[inline]
            pub fn add_min_lo4(&mut self, min_lo4: u32) {
                self.fbb_
                    .push_slot::<u32>(Statistics::VT_MIN_LO4, min_lo4, 0);
            }
            #[inline]
            pub fn add_min_lo8(&mut self, min_lo8: u64) {
                self.fbb_
                    .push_slot::<u64>(Statistics::VT_MIN_LO8, min_lo8, 0);
            }
            #[inline]
            pub fn add_min_hi8(&mut self, min_hi8: u64) {
                self.fbb_
                    .push_slot::<u64>(Statistics::VT_MIN_HI8, min_hi8, 0);
            }
            #[inline]
            pub fn add_min_len(&mut self, min_len: i8) {
                self.fbb_
                    .push_slot_always::<i8>(Statistics::VT_MIN_LEN, min_len);
            }
            #[inline]
            pub fn add_max_lo4(&mut self, max_lo4: u32) {
                self.fbb_
                    .push_slot::<u32>(Statistics::VT_MAX_LO4, max_lo4, 0);
            }
            #[inline]
            pub fn add_max_lo8(&mut self, max_lo8: u64) {
                self.fbb_
                    .push_slot::<u64>(Statistics::VT_MAX_LO8, max_lo8, 0);
            }
            #[inline]
            pub fn add_max_hi8(&mut self, max_hi8: u64) {
                self.fbb_
                    .push_slot::<u64>(Statistics::VT_MAX_HI8, max_hi8, 0);
            }
            #[inline]
            pub fn add_max_len(&mut self, max_len: i8) {
                self.fbb_
                    .push_slot_always::<i8>(Statistics::VT_MAX_LEN, max_len);
            }
            #[inline]
            pub fn add_prefix(&mut self, prefix: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(Statistics::VT_PREFIX, prefix);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> StatisticsBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                StatisticsBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> AesGcmV1<'a> {
            ...
            >(
                ...
                if let Some(x) = args.aad_file_unique {
                    builder.add_aad_file_unique(x);
                }
                if let Some(x) = args.aad_prefix {
                    builder.add_aad_prefix(x);
                }
            ...
            pub fn supply_aad_prefix(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(AesGcmV1::VT_SUPPLY_AAD_PREFIX, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AesGcmV1Builder<'a, 'b, A> {
            #[inline]
            pub fn add_aad_prefix(
                &mut self,
                aad_prefix: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i8>>,
            ) {
            ...
            #[inline]
            pub fn add_aad_file_unique(
                &mut self,
                aad_file_unique: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i8>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    AesGcmV1::VT_AAD_FILE_UNIQUE,
                    aad_file_unique,
        ...
        impl<'a> AesGcmCtrV1<'a> {
            ...
            pub fn aad_file_unique(&self) -> Option<::flatbuffers::Vector<'a, i8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i8>>>(
                            AesGcmCtrV1::VT_AAD_FILE_UNIQUE,
                            None,
                        )
                }
            }
            ...
            pub fn supply_aad_prefix(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(AesGcmCtrV1::VT_SUPPLY_AAD_PREFIX, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AesGcmCtrV1Builder<'a, 'b, A> {
            ...
            pub fn add_supply_aad_prefix(&mut self, supply_aad_prefix: bool) {
                self.fbb_.push_slot::<bool>(
                    AesGcmCtrV1::VT_SUPPLY_AAD_PREFIX,
                    supply_aad_prefix,
                    false,
                );
            }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> EncryptionWithFooterKeyBuilder<'a, 'b, A> {
            ...
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> EncryptionWithFooterKeyBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> EncryptionWithColumnKey<'a> {
            ...
            >(
                ...
                if let Some(x) = args.key_metadata {
                    builder.add_key_metadata(x);
                }
                if let Some(x) = args.path_in_schema {
                    builder.add_path_in_schema(x);
                }
                builder.finish()
            }
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<
                            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>,
                        >>(EncryptionWithColumnKey::VT_PATH_IN_SCHEMA, None)
                        .unwrap()
                }
            }
            ...
            pub fn key_metadata(&self) -> Option<::flatbuffers::Vector<'a, i8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i8>>>(
                            EncryptionWithColumnKey::VT_KEY_METADATA,
                            None,
                        )
                }
            }
        ...
        impl ::flatbuffers::Verifiable for EncryptionWithColumnKey<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>("path_in_schema", Self::VT_PATH_IN_SCHEMA, true)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i8>>>(
                        "key_metadata",
                        Self::VT_KEY_METADATA,
                        false,
                    )?
                    .finish();
                Ok(())
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> EncryptionWithColumnKeyBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_path_in_schema(
                &mut self,
                path_in_schema: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<&'b str>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    EncryptionWithColumnKey::VT_PATH_IN_SCHEMA,
                    path_in_schema,
                );
            }
            #[inline]
            pub fn add_key_metadata(
                &mut self,
                key_metadata: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i8>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    EncryptionWithColumnKey::VT_KEY_METADATA,
                    key_metadata,
            ...
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> EncryptionWithColumnKeyBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> FileCryptoMetaData<'a> {
            ...
            >(
                ...
                if let Some(x) = args.encryption_algorithm {
                    builder.add_encryption_algorithm(x);
                }
                ...
                unsafe {
                    self._tab
                        .get::<EncryptionAlgorithm>(
                            FileCryptoMetaData::VT_ENCRYPTION_ALGORITHM_TYPE,
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(
                            FileCryptoMetaData::VT_ENCRYPTION_ALGORITHM,
                            None,
                        )
                        .unwrap()
                }
            ...
            pub fn key_metadata(&self) -> Option<::flatbuffers::Vector<'a, i8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i8>>>(
                            FileCryptoMetaData::VT_KEY_METADATA,
                            None,
                        )
                }
            }
     ...
     .finish();
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FileCryptoMetaDataBuilder<'a, 'b, A> {
            #[inline]
            pub fn add_encryption_algorithm_type(
                &mut self,
                encryption_algorithm_type: EncryptionAlgorithm,
            ) {
                self.fbb_.push_slot::<EncryptionAlgorithm>(
                    FileCryptoMetaData::VT_ENCRYPTION_ALGORITHM_TYPE,
            ...
            pub fn add_encryption_algorithm(
                &mut self,
                encryption_algorithm: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    FileCryptoMetaData::VT_ENCRYPTION_ALGORITHM,
            ...
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> FileCryptoMetaDataBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl ::core::fmt::Debug for FileCryptoMetaData<'_> {
            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                ...
                ds.field(
                    "encryption_algorithm_type",
                    &self.encryption_algorithm_type(),
                );
        ...
        impl<'a> SchemaElement<'a> {
            ...
            >(
                ...
                if let Some(x) = args.column_order {
                    builder.add_column_order(x);
                }
                if let Some(x) = args.field_id {
                    builder.add_field_id(x);
                }
                builder.add_num_children(args.num_children);
                if let Some(x) = args.type_length {
                    builder.add_type_length(x);
                }
                if let Some(x) = args.logical_type {
                    builder.add_logical_type(x);
                }
            ...
            pub fn name(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(SchemaElement::VT_NAME, None)
                }
            }
            #[inline]
            ...
            pub fn repetition_type(&self) -> FieldRepetitionType {
                ...
                unsafe {
                    self._tab
                        .get::<FieldRepetitionType>(
                            SchemaElement::VT_REPETITION_TYPE,
            ...
            pub fn logical_type_type(&self) -> LogicalType {
                ...
                unsafe {
                    self._tab
                        .get::<LogicalType>(
                            SchemaElement::VT_LOGICAL_TYPE_TYPE,
            ...
            pub fn num_children(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(SchemaElement::VT_NUM_CHILDREN, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            ...
            pub fn column_order_type(&self) -> ColumnOrder {
                ...
                unsafe {
                    self._tab
                        .get::<ColumnOrder>(
                            SchemaElement::VT_COLUMN_ORDER_TYPE,
                            Some(ColumnOrder::NONE),
                        )
                        .unwrap()
                }
            }
     ...
     .finish();
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SchemaElementBuilder<'a, 'b, A> {
            ...
            pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(SchemaElement::VT_NAME, name);
            }
            #[inline]
            pub fn add_type_(&mut self, type_: Type) {
                self.fbb_
                    .push_slot_always::<Type>(SchemaElement::VT_TYPE_, type_);
            }
            #[inline]
            pub fn add_repetition_type(&mut self, repetition_type: FieldRepetitionType) {
                self.fbb_.push_slot::<FieldRepetitionType>(
                    SchemaElement::VT_REPETITION_TYPE,
                    repetition_type,
                    FieldRepetitionType::REQUIRED,
                );
            ...
            pub fn add_logical_type_type(&mut self, logical_type_type: LogicalType) {
                self.fbb_.push_slot::<LogicalType>(
                    SchemaElement::VT_LOGICAL_TYPE_TYPE,
                    logical_type_type,
                    LogicalType::NONE,
                );
            ...
            #[inline]
            pub fn add_logical_type(
                &mut self,
                logical_type: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    SchemaElement::VT_LOGICAL_TYPE,
                    logical_type,
            ...
            pub fn add_type_length(&mut self, type_length: i32) {
                self.fbb_
                    .push_slot_always::<i32>(SchemaElement::VT_TYPE_LENGTH, type_length);
            }
            #[inline]
            pub fn add_num_children(&mut self, num_children: i32) {
                self.fbb_
                    .push_slot::<i32>(SchemaElement::VT_NUM_CHILDREN, num_children, 0);
            }
            #[inline]
            pub fn add_field_id(&mut self, field_id: i32) {
                self.fbb_
                    .push_slot_always::<i32>(SchemaElement::VT_FIELD_ID, field_id);
            }
            #[inline]
            pub fn add_column_order_type(&mut self, column_order_type: ColumnOrder) {
                self.fbb_.push_slot::<ColumnOrder>(
                    SchemaElement::VT_COLUMN_ORDER_TYPE,
                    column_order_type,
                    ColumnOrder::NONE,
                );
            ...
            #[inline]
            pub fn add_column_order(
                &mut self,
                column_order: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    SchemaElement::VT_COLUMN_ORDER,
                    column_order,
        ...
        impl<'a> KV<'a> {
            ...
            pub fn key(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(KV::VT_KEY, None)
                }
            }
            #[inline]
            pub fn val(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(KV::VT_VAL, None)
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> KVBuilder<'a, 'b, A> {
            ...
            pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(KV::VT_KEY, key);
            }
            #[inline]
            pub fn add_val(&mut self, val: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(KV::VT_VAL, val);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> ColumnMetadata<'a> {
            ...
            >(
                ...
                if let Some(x) = args.bloom_filter_offset {
                    builder.add_bloom_filter_offset(x);
                }
                if let Some(x) = args.dictionary_page_offset {
                    builder.add_dictionary_page_offset(x);
                }
                if let Some(x) = args.index_page_offset {
                    builder.add_index_page_offset(x);
                }
                ...
                if let Some(x) = args.num_values {
                    builder.add_num_values(x);
                }
                if let Some(x) = args.bloom_filter_length {
                    builder.add_bloom_filter_length(x);
                }
                if let Some(x) = args.statistics {
                    builder.add_statistics(x);
                }
                if let Some(x) = args.key_value_metadata {
                    builder.add_key_value_metadata(x);
                }
            ...
            pub fn total_uncompressed_size(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_TOTAL_UNCOMPRESSED_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn total_compressed_size(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_TOTAL_COMPRESSED_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn key_value_metadata(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KV<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KV>>,
                    >>(ColumnMetadata::VT_KEY_VALUE_METADATA, None)
                }
            }
            #[inline]
            pub fn data_page_offset(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_DATA_PAGE_OFFSET, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn index_page_offset(&self) -> Option<i64> {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_INDEX_PAGE_OFFSET, None)
                }
            }
            #[inline]
            pub fn dictionary_page_offset(&self) -> Option<i64> {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_DICTIONARY_PAGE_OFFSET, None)
                }
            }
            #[inline]
            pub fn statistics(&self) -> Option<Statistics<'a>> {
                ...
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<Statistics>>(
                        ColumnMetadata::VT_STATISTICS,
                        None,
                    )
                }
            }
            ...
            pub fn is_fully_dict_encoded(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(ColumnMetadata::VT_IS_FULLY_DICT_ENCODED, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn bloom_filter_offset(&self) -> Option<i64> {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(ColumnMetadata::VT_BLOOM_FILTER_OFFSET, None)
                }
            }
            #[inline]
            pub fn bloom_filter_length(&self) -> Option<i32> {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(ColumnMetadata::VT_BLOOM_FILTER_LENGTH, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<i64>(
                        ...
                        Self::VT_TOTAL_UNCOMPRESSED_SIZE,
                        false,
                    )?
                    .visit_field::<i64>(
                        "total_compressed_size",
                        Self::VT_TOTAL_COMPRESSED_SIZE,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<KV>>,
                    >>("key_value_metadata", Self::VT_KEY_VALUE_METADATA, false)?
                    ...
                    .visit_field::<i64>(
                        ...
                        Self::VT_DICTIONARY_PAGE_OFFSET,
                        false,
                    )?
                    .visit_field::<::flatbuffers::ForwardsUOffset<Statistics>>(
                        "statistics",
                        Self::VT_STATISTICS,
                        false,
                    )?
        ...
        pub struct ColumnMetadataArgs<'a> {
            ...
            pub key_value_metadata: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<KV<'a>>>,
                >,
            >,
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ColumnMetadataBuilder<'a, 'b, A> {
            ...
            pub fn add_codec(&mut self, codec: CompressionCodec) {
                self.fbb_.push_slot::<CompressionCodec>(
                    ColumnMetadata::VT_CODEC,
                    codec,
                    CompressionCodec::UNCOMPRESSED,
                );
            ...
            pub fn add_num_values(&mut self, num_values: i64) {
                self.fbb_
                    .push_slot_always::<i64>(ColumnMetadata::VT_NUM_VALUES, num_values);
            }
            #[inline]
            pub fn add_total_uncompressed_size(&mut self, total_uncompressed_size: i64) {
                self.fbb_.push_slot::<i64>(
                    ColumnMetadata::VT_TOTAL_UNCOMPRESSED_SIZE,
                    total_uncompressed_size,
                    0,
                );
            }
            ...
            pub fn add_total_compressed_size(&mut self, total_compressed_size: i64) {
                self.fbb_.push_slot::<i64>(
                    ColumnMetadata::VT_TOTAL_COMPRESSED_SIZE,
                    total_compressed_size,
                    0,
                );
            }
            #[inline]
            pub fn add_key_value_metadata(
                &mut self,
                key_value_metadata: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<KV<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    ColumnMetadata::VT_KEY_VALUE_METADATA,
                    key_value_metadata,
                );
            }
            #[inline]
            pub fn add_data_page_offset(&mut self, data_page_offset: i64) {
                self.fbb_.push_slot::<i64>(
                    ColumnMetadata::VT_DATA_PAGE_OFFSET,
                    data_page_offset,
                    0,
                );
            }
            ...
            pub fn add_index_page_offset(&mut self, index_page_offset: i64) {
                self.fbb_.push_slot_always::<i64>(
                    ColumnMetadata::VT_INDEX_PAGE_OFFSET,
                    index_page_offset,
                );
            }
            #[inline]
            pub fn add_dictionary_page_offset(&mut self, dictionary_page_offset: i64) {
                self.fbb_.push_slot_always::<i64>(
                    ColumnMetadata::VT_DICTIONARY_PAGE_OFFSET,
                    dictionary_page_offset,
                );
            }
            #[inline]
            pub fn add_statistics(&mut self, statistics: ::flatbuffers::WIPOffset<Statistics<'b>>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<Statistics>>(
                        ColumnMetadata::VT_STATISTICS,
                        statistics,
                    );
            }
            ...
            pub fn add_is_fully_dict_encoded(&mut self, is_fully_dict_encoded: bool) {
                self.fbb_.push_slot::<bool>(
                    ColumnMetadata::VT_IS_FULLY_DICT_ENCODED,
                    is_fully_dict_encoded,
                    false,
                );
            }
            ...
            pub fn add_bloom_filter_offset(&mut self, bloom_filter_offset: i64) {
                self.fbb_.push_slot_always::<i64>(
                    ColumnMetadata::VT_BLOOM_FILTER_OFFSET,
                    bloom_filter_offset,
                );
            }
            #[inline]
            pub fn add_bloom_filter_length(&mut self, bloom_filter_length: i32) {
                self.fbb_.push_slot_always::<i32>(
                    ColumnMetadata::VT_BLOOM_FILTER_LENGTH,
                    bloom_filter_length,
                );
            }
            #[inline]
        ...
        impl<'a> ColumnChunk<'a> {
            ...
            >(
                ...
                if let Some(x) = args.encrypted_column_metadata {
                    builder.add_encrypted_column_metadata(x);
                }
                if let Some(x) = args.crypto_metadata {
                    builder.add_crypto_metadata(x);
                }
                if let Some(x) = args.meta_data {
                    builder.add_meta_data(x);
                }
            ...
            pub fn meta_data(&self) -> Option<ColumnMetadata<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<ColumnMetadata>>(
                            ColumnChunk::VT_META_DATA,
                            None,
                        )
                }
            }
            ...
            pub fn crypto_metadata_type(&self) -> ColumnCryptoMetaData {
                ...
                unsafe {
                    self._tab
                        .get::<ColumnCryptoMetaData>(
                            ColumnChunk::VT_CRYPTO_METADATA_TYPE,
                            Some(ColumnCryptoMetaData::NONE),
                        )
                        .unwrap()
                }
            }
            ...
            pub fn crypto_metadata(&self) -> Option<::flatbuffers::Table<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(
                            ColumnChunk::VT_CRYPTO_METADATA,
                            None,
                        )
                }
            }
            ...
            pub fn encrypted_column_metadata(&self) -> Option<::flatbuffers::Vector<'a, i8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i8>>>(
                            ColumnChunk::VT_ENCRYPTED_COLUMN_METADATA,
                            None,
                        )
                }
            }
            #[inline]
            #[allow(non_snake_case)]
            pub fn crypto_metadata_as_encryption_with_footer_key(
                &self,
            ) -> Option<EncryptionWithFooterKey<'a>> {
            ...
            #[inline]
            #[allow(non_snake_case)]
            pub fn crypto_metadata_as_encryption_with_column_key(
                &self,
            ) -> Option<EncryptionWithColumnKey<'a>> {
     ...
     .finish();
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ColumnChunkBuilder<'a, 'b, A> {
            ...
            pub fn add_meta_data(
                &mut self,
                meta_data: ::flatbuffers::WIPOffset<ColumnMetadata<'b>>,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<ColumnMetadata>>(
                        ColumnChunk::VT_META_DATA,
                        meta_data,
                    );
            }
            ...
            pub fn add_crypto_metadata_type(&mut self, crypto_metadata_type: ColumnCryptoMetaData) {
                self.fbb_.push_slot::<ColumnCryptoMetaData>(
                    ColumnChunk::VT_CRYPTO_METADATA_TYPE,
            ...
            #[inline]
            pub fn add_crypto_metadata(
                &mut self,
                crypto_metadata: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    ColumnChunk::VT_CRYPTO_METADATA,
                    crypto_metadata,
            ...
            #[inline]
            pub fn add_encrypted_column_metadata(
                &mut self,
                encrypted_column_metadata: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i8>>,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    ColumnChunk::VT_ENCRYPTED_COLUMN_METADATA,
        ...
        impl ::core::fmt::Debug for ColumnChunk<'_> {
            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                ...
                ds.field(
                    "encrypted_column_metadata",
                    &self.encrypted_column_metadata(),
                );
                ds.finish()
            }
        }
        ...
        impl<'a> SortingColumn<'a> {
            ...
            pub fn column_idx(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(SortingColumn::VT_COLUMN_IDX, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn descending(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(SortingColumn::VT_DESCENDING, Some(false))
                        .unwrap()
                }
            }
            #[inline]
            pub fn nulls_first(&self) -> bool {
                ...
                unsafe {
                    self._tab
                        .get::<bool>(SortingColumn::VT_NULLS_FIRST, Some(false))
                        .unwrap()
                }
            }
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SortingColumnBuilder<'a, 'b, A> {
            ...
            pub fn add_column_idx(&mut self, column_idx: i32) {
                self.fbb_
                    .push_slot::<i32>(SortingColumn::VT_COLUMN_IDX, column_idx, 0);
            }
            #[inline]
            pub fn add_descending(&mut self, descending: bool) {
                self.fbb_
                    .push_slot::<bool>(SortingColumn::VT_DESCENDING, descending, false);
            }
            #[inline]
            pub fn add_nulls_first(&mut self, nulls_first: bool) {
                self.fbb_
                    .push_slot::<bool>(SortingColumn::VT_NULLS_FIRST, nulls_first, false);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> SortingColumnBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
        ...
        impl<'a> RowGroup<'a> {
            ...
            >(
                ...
                if let Some(x) = args.sorting_columns {
                    builder.add_sorting_columns(x);
                }
                if let Some(x) = args.columns {
                    builder.add_columns(x);
                }
                if let Some(x) = args.ordinal {
                    builder.add_ordinal(x);
                }
                builder.finish()
            }
            ...
            pub fn columns(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ColumnChunk<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ColumnChunk>>,
                    >>(RowGroup::VT_COLUMNS, None)
                }
            }
            #[inline]
            pub fn total_byte_size(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(RowGroup::VT_TOTAL_BYTE_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn num_rows(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(RowGroup::VT_NUM_ROWS, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn sorting_columns(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SortingColumn<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SortingColumn>>,
                    >>(RowGroup::VT_SORTING_COLUMNS, None)
                }
            }
            #[inline]
            pub fn file_offset(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(RowGroup::VT_FILE_OFFSET, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn total_compressed_size(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(RowGroup::VT_TOTAL_COMPRESSED_SIZE, Some(0))
                        .unwrap()
                }
            }
            #[inline]
        ...
        impl ::flatbuffers::Verifiable for RowGroup<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<ColumnChunk>>,
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<SortingColumn>>,
                    >>("sorting_columns", Self::VT_SORTING_COLUMNS, false)?
        ...
        pub struct RowGroupArgs<'a> {
            pub columns: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<ColumnChunk<'a>>>,
                >,
            >,
            pub total_byte_size: i64,
            pub num_rows: i64,
            pub sorting_columns: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SortingColumn<'a>>>,
                >,
            >,
            pub file_offset: i64,
            pub total_compressed_size: i64,
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RowGroupBuilder<'a, 'b, A> {
            ...
            pub fn add_columns(
                ...
                columns: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<ColumnChunk<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(RowGroup::VT_COLUMNS, columns);
            }
            #[inline]
            pub fn add_total_byte_size(&mut self, total_byte_size: i64) {
                self.fbb_
                    .push_slot::<i64>(RowGroup::VT_TOTAL_BYTE_SIZE, total_byte_size, 0);
            }
            #[inline]
            pub fn add_num_rows(&mut self, num_rows: i64) {
                self.fbb_
                    .push_slot::<i64>(RowGroup::VT_NUM_ROWS, num_rows, 0);
            }
            #[inline]
            pub fn add_sorting_columns(
                &mut self,
                sorting_columns: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<SortingColumn<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    RowGroup::VT_SORTING_COLUMNS,
                    sorting_columns,
                );
            }
            #[inline]
            pub fn add_file_offset(&mut self, file_offset: i64) {
                self.fbb_
                    .push_slot::<i64>(RowGroup::VT_FILE_OFFSET, file_offset, 0);
            }
            #[inline]
            pub fn add_total_compressed_size(&mut self, total_compressed_size: i64) {
                self.fbb_.push_slot::<i64>(
                    RowGroup::VT_TOTAL_COMPRESSED_SIZE,
                    total_compressed_size,
                    0,
                );
            }
            ...
            pub fn add_ordinal(&mut self, ordinal: i16) {
                self.fbb_
                    .push_slot_always::<i16>(RowGroup::VT_ORDINAL, ordinal);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> RowGroupBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                RowGroupBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> FileMetaData<'a> {
            ...
            >(
                ...
                builder.add_num_rows(args.num_rows);
                if let Some(x) = args.footer_signing_key_metadata {
                    builder.add_footer_signing_key_metadata(x);
                }
                if let Some(x) = args.encryption_algorithm {
                    builder.add_encryption_algorithm(x);
                }
                if let Some(x) = args.created_by {
                    builder.add_created_by(x);
                }
                if let Some(x) = args.kv {
                    builder.add_kv(x);
                }
            ...
            pub fn version(&self) -> i32 {
                ...
                unsafe {
                    self._tab
                        .get::<i32>(FileMetaData::VT_VERSION, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn schema(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SchemaElement<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SchemaElement>>,
                    >>(FileMetaData::VT_SCHEMA, None)
                }
            }
            #[inline]
            pub fn num_rows(&self) -> i64 {
                ...
                unsafe {
                    self._tab
                        .get::<i64>(FileMetaData::VT_NUM_ROWS, Some(0))
                        .unwrap()
                }
            }
            #[inline]
            pub fn row_groups(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<RowGroup<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<RowGroup>>,
                    >>(FileMetaData::VT_ROW_GROUPS, None)
                }
            }
            #[inline]
            pub fn kv(
            ...
            pub fn encryption_algorithm_type(&self) -> EncryptionAlgorithm {
                ...
                unsafe {
                    self._tab
                        .get::<EncryptionAlgorithm>(
                            FileMetaData::VT_ENCRYPTION_ALGORITHM_TYPE,
                            Some(EncryptionAlgorithm::NONE),
                        )
                        .unwrap()
                }
            ...
            pub fn encryption_algorithm(&self) -> Option<::flatbuffers::Table<'a>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Table<'a>>>(
                            FileMetaData::VT_ENCRYPTION_ALGORITHM,
                            None,
                        )
                }
            }
            ...
            pub fn footer_signing_key_metadata(&self) -> Option<::flatbuffers::Vector<'a, i8>> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i8>>>(
                            FileMetaData::VT_FOOTER_SIGNING_KEY_METADATA,
                            None,
                        )
                }
            }
     ...
     .finish();
        ...
        pub struct FileMetaDataArgs<'a> {
            ...
            pub schema: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<SchemaElement<'a>>>,
                >,
            >,
            pub num_rows: i64,
            pub row_groups: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<RowGroup<'a>>>,
                >,
            >,
            pub kv: Option<
                ::flatbuffers::WIPOffset<
            ...
            pub encryption_algorithm:
                Option<::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>>,
            pub footer_signing_key_metadata:
                Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, i8>>>,
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FileMetaDataBuilder<'a, 'b, A> {
            ...
            pub fn add_version(&mut self, version: i32) {
                self.fbb_
                    .push_slot::<i32>(FileMetaData::VT_VERSION, version, 0);
            }
            #[inline]
            pub fn add_schema(
                &mut self,
                schema: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<SchemaElement<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    FileMetaData::VT_SCHEMA,
                    schema,
                );
            }
            #[inline]
            pub fn add_num_rows(&mut self, num_rows: i64) {
                self.fbb_
                    .push_slot::<i64>(FileMetaData::VT_NUM_ROWS, num_rows, 0);
            }
            #[inline]
            pub fn add_row_groups(
                &mut self,
                row_groups: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<RowGroup<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    FileMetaData::VT_ROW_GROUPS,
                    row_groups,
                );
            }
            #[inline]
            pub fn add_kv(
                &mut self,
                kv: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<KV<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(FileMetaData::VT_KV, kv);
            }
            #[inline]
            ...
            #[inline]
            pub fn add_footer_signing_key_metadata(
                &mut self,
                footer_signing_key_metadata: ::flatbuffers::WIPOffset<
        ...
        pub fn root_as_file_meta_data(
            buf: &[u8],
        ) -> Result<FileMetaData<'_>, ::flatbuffers::InvalidFlatbuffer> {
        ...
        pub fn size_prefixed_root_as_file_meta_data(
            buf: &[u8],
        ) -> Result<FileMetaData<'_>, ::flatbuffers::InvalidFlatbuffer> {
        ...
        pub unsafe fn size_prefixed_root_as_file_meta_data_unchecked(
            buf: &[u8],
        ) -> FileMetaData<'_> {
        ...
        #[inline]
        pub fn finish_size_prefixed_file_meta_data_buffer<
            'a,
            'b,
