...
- Support DictionaryArray in divide kernel [\#1982](https://github.com/apache/arrow-rs/issues/1982)
...
- Add `Decimal256Builder` and `Decimal256Array` [\#2000](https://github.com/apache/arrow-rs/pull/2000) [[parquet](https://github.com/apache/arrow-rs/labels/parquet)] [[arrow](https://github.com/apache/arrow-rs/labels/arrow)] ([viirya](https://github.com/viirya))
