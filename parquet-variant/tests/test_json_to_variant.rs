...
fn test_json_to_variant() -> Result<(), ArrowError> {
    ...
    compare_results(
        ...
        &[
            1u8, 3u8, 0u8, 7u8, 11u8, 19u8, 0x6eu8, 0x75u8, 0x6du8, 0x62u8, 0x65u8, 0x72u8, 0x73u8,
            0x6eu8, 0x75u8, 0x6cu8, 0x6cu8, 0x62u8, 0x6fu8, 0x6fu8, 0x6cu8, 0x65u8, 0x61u8, 0x6eu8,
            0x73u8,
        ],
    )?;
